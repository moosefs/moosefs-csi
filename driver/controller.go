...
func NewControllerService(mfsmaster, rootPath, pluginDataPath string) (*ControllerService, error) {
	log.Infof("NewControllerService creation - mfsmaster %s, rootDir %s, pluginDataDir %s)", mfsmaster, rootPath, pluginDataPath)

	ctlMount := NewMfsHandler(mfsmaster, rootPath, pluginDataPath, "controller")
