...
Driver verson 1.0.0
* Update MooseFS client to version 4.58.4.
...
3.  Update `deploy/csi-moosefs.yaml` file with the aproprieate image:
    ...
    * Update the `image` version suffix in the plugin's section accordingly:
        * `1.0.0-4.58.4`       – plugin version 1.0.0 and MooseFS CE 4.58.4
      ...
      Fot driver with MooseFS client PRO version: https://registry.moosefs.com/v2/moosefs-csi-plugin/tags/list.
        * `1.0.0-4.58.4-pro`   – plugin version 1.0.0 and MooseFS PRO 4.58.4
